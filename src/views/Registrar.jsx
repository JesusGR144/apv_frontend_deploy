...
const Registrar = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (password.length < 6) {
      ...
      //   error: true,
      // });
      mostrarAlerta('Password muy corto, ingresa mínimo 6 caracteres', true)
      return;
    }
    ...
    try {      
      ...
      //   error: false
      // })
      mostrarAlerta('Creado correctamente, revisa tu email')
    } catch (error) {
      // setAlerta({
  ...
  return (
    <>
      <div>
        <h1 className="text-emerald-600 font-black text-6xl text-center">
